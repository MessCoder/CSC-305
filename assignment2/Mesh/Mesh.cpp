...
// Causes a collision as main includes "OpenGP/GL/glfw_helpers.h"
// which includes "OpenGP/GL/glfw_helpers.h".
//
// #include "OpenGP/GL/shader_helpers.h"
//
// Using a forward declaration instead;
...
void Mesh::loadVertices(const std::vector<OpenGP::Vec3> &vertexArray, const std::vector<unsigned int> &indexArray) {
...
void Mesh::loadNormals(const std::vector<OpenGP::Vec3> &normalArray) {
...
void Mesh::loadTexCoords(const std::vector<OpenGP::Vec2> &tCoordArray) {
	this->tCoordArray = tCoordArray;
...
void Mesh::draw(OpenGP::Mat4x4 Model, OpenGP::Mat4x4 View, OpenGP::Mat4x4 Projection) {
...
std::vector<OpenGP::Vec3> Mesh::getVertexArray() {
	return this->vertexArray;
}

std::vector<unsigned int> Mesh::getIndexArray() {
	return this->indexArray;
}

std::vector<OpenGP::Vec3> Mesh::getNormalArray() {
	return this->normalArray;
}

std::vector<OpenGP::Vec2> Mesh::getTCoordArray() {
	return this->tCoordArray;
}
